        ...
        <div class="container">
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <a href="{{ route('terms.create') }}" class="btn btn-primary btn-md">Add Terms and Condtions</a>
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <p>Are you sure you want to delete this terms and conitions?
                                                            </p>
                                                            <p><strong>Term:</strong> {{ $item->id }}</p>
                                                        </div>
