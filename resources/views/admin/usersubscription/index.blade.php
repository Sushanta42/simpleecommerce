        ...
        <div class="container">
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <a href="{{ route('usersubscription.create') }}" class="btn btn-primary btn-md">Add User
                        Subscription</a>
                ...
                <div class="card-body">
                    <table class="table" id="save-stage" style="width:100%;">
                        ...
                        <tbody style="font-size: 14px">
                            @foreach ($usersubscriptions as $index => $item)
                                <tr class="border border-1">
                                    ...
                                    <td class="border border-1">{{ $item->subscription->name }}</td>
                                    <td class="border border-1">{{ $item->subscription->duration }}</td>
                                    ...
                                    <td class="border border-1">
                                        <form action="{{ route('usersubscription.destroy', $item->id) }}" method="post">
                                            @csrf
                                            @method('delete')

                                            <div class="d-flex">
                                                <a href="{{ route('usersubscription.edit', $item->id) }}"
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <p><strong>Duration:</strong>
                                                                {{ $item->subscription->duration }}</p>
                                                        </div>
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-primary"
                                                                data-dismiss="modal">Cancel</button>
                                                            <form
                                                                action="{{ route('usersubscription.destroy', $item->id) }}"
                                                                method="post">
                                                                @csrf
                                                                @method('delete')
                                                                <button type="submit"
