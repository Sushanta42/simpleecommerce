        ...
        <div class="container">
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <a href="{{ route('privacypolicy.index') }}" class="btn btn-primary btn-sm">Back</a>
                ...
                <div class="card-body">
                    <form action="{{ route('privacypolicy.update', $privacypolicy->id) }}" method="post"
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="description" class="summernote" name="description" rows="4">{{ $privacypolicy->description }}</textarea>
                            @error('description')
