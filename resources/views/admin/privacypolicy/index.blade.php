        ...
        <div class="container">
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <a href="{{ route('privacypolicy.create') }}" class="btn btn-primary btn-md">Add Privacy Policies</a>
                ...
                <div class="card-body">
                    <table class="table" id="save-stage" style="width:100%;">
                        ...
                        <tbody style="font-size: 14px">
                            @foreach ($privacypolicies as $index => $item)
                                <tr class="border border-1">
                                    ...
                                    <td class="border border-1">
                                        <form action="{{ route('privacypolicy.destroy', $item->id) }}" method="post">
                                            @csrf
                                            @method('delete')
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <p>Are you sure you want to delete this privacy policy?
                                                            </p>
                                                            <p><strong>Privacy Policy:</strong> {{ $item->id }}</p>
                                                        </div>
