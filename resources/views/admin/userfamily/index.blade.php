        ...
        <div class="container">
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <a href="{{ route('userfamily.create') }}" class="btn btn-primary btn-md">Add Customer Family</a>
                    <h4>Customers With Family Detail</h4>
                </div>
                <div class="card-body">
                    <table class="table" id="save-stage" style="width:100%;">
                        <thead>
                            <tr>
                                ...
                                <th class="border border-1">Customer Phone</th>
                                <th class="border border-1">Member Name</th>
                        ...
                        <tbody style="font-size: 14px">
                            @foreach ($userfamilies as $index => $item)
                                <tr>
                                    ...
                                    <td class="border border-1">{{ $item->mobile }}</td>
                                    <td class="border border-1">{{ $item->phone ?? 'null' }}</td>
                                    <td class="border border-1">{{ $item->dob ?? 'null' }}</td>
                                    <td class="border border-1">
                                        <form action="{{ route('userfamily.destroy', $item->id) }}" method="post">
                                            @csrf
                                            @method('delete')

                                            <div class="d-flex">
                                                <a href="{{ route('userfamily.edit', $item->id) }}"
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <p>Are you sure you want to delete this user family member?
                                                            </p>
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <form action="{{ route('userfamily.destroy', $item->id) }}"
                                                                method="post">
                                                                @csrf
                                                                @method('delete')
                                                                <button type="submit"
