        ...
        <div class="container">
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <a href="{{ route('aboutus.index') }}" class="btn btn-primary btn-sm">Back</a>
                    <h4>Edit About Us</h4>
                </div>
                <div class="card-body">
                    <form action="{{ route('aboutus.update', $aboutus->id) }}" method="post"
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="description" class="summernote" name="description" rows="4">{{ $aboutus->description }}</textarea>
                            @error('description')
